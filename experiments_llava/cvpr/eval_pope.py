...
parser.add_argument("--gt_files", type=str, default="/CausalLens/experiments_llava/data/POPE/coco/coco_pope_popular.json")
parser.add_argument("--gen_files", type=str, default="/CausalLens/experiments_llava/cvpr/cocopopourllava1.5my_0.15_10_20.jsonl")
